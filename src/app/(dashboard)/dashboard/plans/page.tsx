...
const plans = [
  {
    ...
    features: [
      ...
      { text: 'Cozinha e comanda impressa', included: false },
      { text: 'Controle de caixa', included: false },
      { text: 'Perguntas frequentes no cardápio', included: false },
  ...
  },
  {
    ...
    features: [
      ...
      { text: 'Cozinha e comanda impressa', included: true },
      { text: 'Controle de caixa', included: true },
      { text: 'Perguntas frequentes no cardápio', included: true },
